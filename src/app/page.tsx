      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3 text-gray-700 bg-gray-50 p-3 rounded-lg">
            ...
            <span>Real-time Vitals & Location</span>
          </div>
          <div className="flex items-center space-x-3 text-gray-700 bg-gray-50 p-3 rounded-lg">
        ...
        <button
          ...
          className="w-full flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-xl transition duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
        >
